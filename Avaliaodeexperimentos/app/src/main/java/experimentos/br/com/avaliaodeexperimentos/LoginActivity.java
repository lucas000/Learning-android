...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((extras != null) && (extras.containsKey("MSG"))) {
            ...
            String mensagem = extras.getString("MSG");
    ...
    private void attemptLoginOrRegister(boolean isNewUser) {
        ...
        // guarda FALSE se não tem dados incorreto; TRUE, caso contrario
            boolean cancel = false;
            // guarda referência para um view (email ou pass)
            // que precisa ser novamente entrado
            View focusView = null;
            // Checa por um password válido
            if (!TextUtils.isEmpty(password) && !isPasswordValid(password)) {
                mPasswordView.setError(getString(R.string.error_invalid_password));
                focusView = mPasswordView;
                cancel = true;
            }
            // Checa por um endereco de email valido.
            ...
            if (cancel) {
                // Há um erro; corrigir antes de tentar logar.
                focusView.requestFocus(); // o foco vai para a view que faliu
            } else {
    ...
    public void irCriarConta(View v){
    ...
    public void recuperarSenha(View v){
        Intent it = new Intent(this, RestaurarSenha.class);
